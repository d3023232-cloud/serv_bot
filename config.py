...
SAND_PRICE = 1           # 1 ед. песка стоит 1 монету (рынок)
...
GATHER_GRID_SIZE = 3          # поле 3x3 (9 клеток)
GATHER_MAX_ATTEMPTS = 8       # максимум попыток найти предмет за игру
GATHER_MENU_TEXT = (
...
GATHER_GAME_TEXT = (
    ...
    "В одной из клеток спрятан <b>{name_lower}</b>. Нажми на нужную клетку!\n"
    "Осталось попыток: <b>{attempts}</b>\n\n"
    "Нашёл — забираешь до <b>{max}</b> {emoji} и уходишь с кулдауном {cd} сек."
)
GATHER_GAME_MISS = "❌ Пусто! Осталось попыток: <b>{attempts}</b>"
GATHER_GAME_FAIL = (
    "😔 <b>Не удалось найти {name_lower}.</b>\n\n"
    "Попытки закончились — ты ушёл ни с чем, но время потеряно: "
